"""
🤖 The Coordinator - LLM-Powered Multi-Agent Orchestrator
...
class CoordinatorAgent:
    ...
    def plan_treatment(self, model_id: str, symptom: str, 
        ...
        console.print(Panel.fit(
            f"🤖 [bold blue]Coordinator Planning Treatment[/bold blue]\n"
            f"Patient: {model_id}\n"
            f"Symptom: {symptom}",
            border_style="blue"
        ))
...
Generate a structured treatment plan."""
    ...
    def coordinate_step(self, step: TreatmentStep, previous_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        console.print(f"\n🤖 [bold]Coordinator:[/bold] Executing {step.agent_name} - {step.action}")
        ...
        # Display instruction
        console.print(f"[dim]📋 Instructions: {step.instructions}[/dim]")
    ...
    def analyze_result(self, agent_name: str, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        console.print(f"\n🤖 [bold]Coordinator:[/bold] Analyzing {agent_name} result...")
...
Provide quality assessment and feedback."""
    ...
    def synthesize_results(self, all_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        console.print("\n🤖 [bold]Coordinator:[/bold] Synthesizing final results...")
...
Provide comprehensive summary and recommendations."""
    ...
    def request_collaboration(self, from_agent: str, to_agent: str, 
        ...
        """
        console.print(f"\n🤖 [bold]Coordinator:[/bold] Routing request: {from_agent} → {to_agent}")
...
Refine and route the request."""
        ...
        console.print(f"[dim]📨 Routed: {response[:100]}...[/dim]")
    ...
    def _parse_treatment_plan(self, response: str, model_id: str, symptom: str) -> TreatmentPlan:
        ...
        try:
            ...
            console.print(f"[yellow]⚠️ Error parsing plan: {e}. Using default.[/yellow]")
    ...
    def _display_plan(self, plan: TreatmentPlan):
        ...
        console.print(f"\n[bold green]📋 Treatment Plan Generated[/bold green]")
    ...
    def _display_analysis(self, agent_name: str, analysis: Dict[str, Any]):
        ...
        if analysis.get("needs_revision"):
            console.print(f"[yellow]🔄 Requesting revision from {agent_name}[/yellow]")
        else:
            console.print("[green]✅ Result approved, proceeding[/green]")
    
    def _display_synthesis(self, synthesis: Dict[str, Any]):
        """Display final synthesis"""
        console.print(Panel.fit(
            f"[bold green]🎯 Final Synthesis[/bold green]\n\n"
    ...
    def save_conversation_history(self, output_path: str):
        ...
        console.print(f"[green]✅ Conversation history saved to {output_path}[/green]")
